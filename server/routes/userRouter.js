...
import { getUserData, listAllUsers, updateUserRole, addStaff, updateStaff, removeStaff } from '../controllers/userController.js';
...
userRouter.patch('/staff/:id', userAuth, roleAuth('admin'), updateStaff);
